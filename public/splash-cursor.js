(function initSplashCursor() {
    ...
    let config = {
        ...
        TRANSPARENT: true,
        RAINBOW_MODE: false,
        COLOR: '#ffafd6' // Match UI primary color
    };
    ...
    function updatePointerDownData(pointer, id, posX, posY) {
        ...
        pointer.deltaX = 0; pointer.deltaY = 0; pointer.color = hexToRGB(config.COLOR);
    }
    ...
    function handleMouseMove(e) {
        ...
        let posX = scaleByPixelRatio(e.clientX);
        let posY = scaleByPixelRatio(e.clientY);
        updatePointerMoveData(pointer, posX, posY, hexToRGB(config.COLOR));
    }
